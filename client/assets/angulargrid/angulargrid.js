          ...
          link: function(scope, element, attrs) {
            ...
            *****/
            ...
            function getScrollContainerInfo() {
              //console.log(options.scrollContainer,'>>>>>>>>>>>>>>>>>>>>>>scroll container');
              var container = $(document.querySelector(options.scrollContainer)), contElm = container[0];
              //console.log(contElm.scrollHeight,"=============contElm.offsetHeight====")
              return {
            ...
            *****/
            ...
            function infiniteScroll(scrollTop) {
              ...
              //console.log(options.infiniteScrollDistance);
              //console.log(scrollHeight,'scroll height',scrollNs.scrollContInfo.scrollHeight);
              //console.log(contHeight,'cont height');
              //console.log(scrollTop,'scroll top');
              //console.log(scrollHeight - contHeight * (1 + options.infiniteScrollDistance / 100),'expression');
            ...
            setTimeout(function() {
              ...
              //console.log(scrollNs.scrollContInfo,">>>>>>>7777777>>>>>>>>>scrollHandler>>>>>>>")
                ...
                afterImageLoad(clones, {
                  ...
                  onFullLoad: function() {
                    ...
                    if (options.performantScroll || scope.infiniteScroll) {
                      scrollNs.scrollContInfo = getScrollContainerInfo();
                      //console.log(scrollNs.scrollContInfo,888888888888)
                    }
